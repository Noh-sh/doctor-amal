...
Модели нужны для отображения страницы. Они не описывают заявки, статьи, платежи, пользовательские аккаунты или админку первой версии.

## Общие правила

- Данные текущей реализации хранятся локально в проекте.
- На Supabase-этапе эти же данные могут читаться из Supabase и преобразовываться в `TaplinkPageData`.
...
На первом Supabase-этапе rows из Supabase должны быть приведены к этим же моделям:
