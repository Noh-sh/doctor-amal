...
- Статус: завершено
- Области: `Процесс`, `Документация`, `AGENTS`, `Roadmap`
- Specs:
  - `AGENTS.md`
  - `.agents/skills/doctor-amal-specs/SKILL.md`
  ...
  - `Roadmap/TEMPLATE.md`
- Сделано:
  - в `AGENTS.md` добавлен явный порядок работы агента: specs -> активный план -> разработка -> проверка -> завершенный план -> Roadmap/changelog -> git;
  - зафиксировано, что `Roadmap/chronology.md` выполняет роль changelog проекта;
  - добавлены правила именования новых технических папок и файлов на будущее;
  - отдельно зафиксировано, что существующие исторические папки и файлы не переименовываются только ради стиля.
- Проверка:
  - `git diff --check` выполнен без ошибок;
  - ручно проверено, что изменение не затрагивает продуктовые specs, код приложения, маршруты, данные или Supabase schema.
- Измененные файлы:
  - `AGENTS.md`
...
- Git:
  ...
  - push: не выполнен
- Следующий шаг:
  - при новых изменениях начинать с актуальных specs и нового активного плана.
