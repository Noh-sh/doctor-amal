...
| 7 | Статьи | Следующий этап | будет создан `Work plans/Активные/007-stati.md` | список статей, страница статьи, скрытие черновиков, состояние “статья не найдена” |
...
Создать и выполнить план 007: статьи.
