...
Код приложения и technical specs еще могут соответствовать старой версии с курсами, заявками и статьями. Перед новой реализацией нужно последовательно переписать оставшиеся specs под новую концепцию.
...
Следующий слой работы: переписать technical specs под Taplink-формат.
...
3. переписать technical specs под Taplink-формат;
