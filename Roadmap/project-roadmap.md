...
| 8 | Главная и страница “О докторе” | Следующий этап | будет создан `Work plans/Активные/008-glavnaya-i-o-doktore.md` | полноценное наполнение главной и страницы о докторе по specs |
...
Создать и выполнить план 008: главная и страница “О докторе”.
