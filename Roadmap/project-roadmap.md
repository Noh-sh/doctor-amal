...
| 5 | Страница курса | Следующий этап | будет создан `Work plans/Активные/005-stranica-kursa.md` | детальная страница курса, условия покупки, Telegram-доступ, правила `open`, `closed`, `coming_soon` |
...
Создать и выполнить план 005: страница курса.
